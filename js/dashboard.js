(function($) { //para el de las barras azules
  'use strict';
  $(function() {
    if ($("#order-chart").length) {
      var areaData = {
        labels: ["Pseint","","","Html","","","Css","","","Js","","", "Python","","", "Bootstrap","","","PHP"],
        datasets: [
          {
            data: [200, 480, 700, 600, 620, 350, 780, 350, 850, "600", "650", "350", "590", "350", "620", "500", "990", "780", "650"],
            borderColor: [
              '#4747A1'
            ],
            borderWidth: 2,
    ...
    if ($("#sales-chart").length) {
      ...
      var SalesChart = new Chart(SalesChartCanvas, {
        type: 'bar',
        data: {
          labels: ["Julio", "Agosto", "Septiembre", "Obtubre", "Noviembre"],
          datasets: [{
              label: 'Front end',
              data: [20, 40, 60, 80, 99],
